...
from APP_YOGA_164.erreurs.msg_erreurs import *
from APP_YOGA_164.essais_wtf_forms.wtf_forms_demo_select import DemoFormSelectWTF
...
def demo_select_wtf():
    ...
    # Objet formulaire pour montrer une liste déroulante basé su    r la table "t_parents"
    ...
    try:
        ...
        if request.method == "GET":
            ...
            # genre_val_list_dropdown = [(i["id_parents"], i["intitule_genre"]) for i in data_genres]
