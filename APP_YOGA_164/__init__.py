...
try:
    ...
    """
    from APP_YOGA_164.database import database_tools
    from APP_YOGA_164.essais_wtf_forms import gestion_essai_wtf
    from APP_YOGA_164.essais_wtf_forms import gestion_wtf_forms_demo_select
    from APP_YOGA_164.parents import gestion_parents_crud
    from APP_YOGA_164.demos_om_164 import routes_demos

    from APP_YOGA_164.enfants_sante import gestion_enfants_sante_crud
    from APP_YOGA_164.erreurs import msg_avertissements

    from APP_YOGA_164.enfants import gestion_enfants_crud
    from APP_YOGA_164.enfants import gestion_enfants_wtf_forms

    from APP_YOGA_164.factures import gestion_factures_crud
    from APP_YOGA_164.factures import gestion_factures_wtf_forms

    from APP_YOGA_164.parents_enfants import gestion_parents_enfants_crud
